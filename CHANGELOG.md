...
- JavaDoc on all Configuration properties has bee updated
...
- upgraded io.sentry:sentry-spring-boot-4 from 8.43.0 to 8.50.1 (previously io.sentry:sentry-spring-boot-starter-jakarta was renamed to io.sentry:sentry-spring-boot-4)
