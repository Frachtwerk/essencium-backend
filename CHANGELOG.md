...
- API-Token - exp from User-Token overrides exp in Api-Token. JWT_RESERVED_CLAIMS are now filtered out of the additional claims in ApiTokenService to avoid overwriting the exp claim from the user token.
