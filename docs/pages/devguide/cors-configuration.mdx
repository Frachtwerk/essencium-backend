...
- [AppCorsProperties.java](https://github.com/Frachtwerk/essencium-backend/blob/main/essencium-backend/src/main/java/de/frachtwerk/essencium/backend/configuration/properties/AppCorsProperties.java)
- [CorsConfig.java](https://github.com/Frachtwerk/essencium-backend/blob/main/essencium-backend/src/main/java/de/frachtwerk/essencium/backend/configuration/CorsConfig.java)
- [AuthenticationController.java](https://github.com/Frachtwerk/essencium-backend/blob/main/essencium-backend/src/main/java/de/frachtwerk/essencium/backend/controller/AuthenticationController.java)
