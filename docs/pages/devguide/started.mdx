...
Please refer to the official [Spring Boot documentation](https://docs.spring.io/spring-boot/docs/current/reference/html/) for more details on setting up Spring Boot in your project.
...
_The above guide assumes that you are using Maven as your project management tool. If you are using Gradle or another tool, the specific steps for adding and updating dependencies may be different._
