...
public class DefaultRestController<
        M extends SequenceIdModel, IN extends Identifiable<Long>, OUT, S extends Specification<M>>
  ...
  public DefaultRestController(DefaultAssemblingEntityService<M, IN, OUT> service) {
    super(service);
    this.abstractAssemblingEntityService = service;
  }

  @Override
  public OUT toRepresentation(M entity) {
