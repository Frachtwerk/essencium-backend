                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 20px; font-weight: bold; margin: 0 0 15px;">
                                            Änderung Ihrer E-Mail-Adresse registriert</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0 0 15px;">
                                            Soeben wurde Ihre E-Mail-Adresse in der Anwendung ${mailBranding.name} bei
                                            einem Profil hinterlegt.</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0 0 15px;">
                                            Um die Aktualisierung wirksam zu machen, klicken Sie bitte auf den
                                            untenstehenden Link. Nach der Verifizierung ist ein Login nur noch mit der
