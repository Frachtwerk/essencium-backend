...
class DefaultLongUserInitializerTest {
  @Mock
  AbstractUserService<UserStub, EssenciumUserDetailsImpl<Long>, Long, UserDto<Long>>
      userServiceMock;
  ...
  void greenFieldTest() {
    ...
    DefaultUserInitializer<UserStub, EssenciumUserDetailsImpl<Long>, UserDto<Long>, Long> SUT =
