...
import de.frachtwerk.essencium.backend.service.translation.XliffParser;
import java.util.Locale;
import org.assertj.core.api.Assertions;
import org.junit.jupiter.api.Test;

class XliffParserTest {

  private final TranslationFileParser testSubject = new XliffParser();

  @Test
  void parse() {
    var testLocale = Locale.JAPANESE;
    var fileToTranslate =
        this.getClass().getClassLoader().getResourceAsStream("testfiles/TranslationXliff.xlf");
