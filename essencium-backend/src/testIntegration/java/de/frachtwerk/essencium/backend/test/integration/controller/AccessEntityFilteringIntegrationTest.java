...
import de.frachtwerk.essencium.backend.test.integration.app.Foreign;
import de.frachtwerk.essencium.backend.test.integration.app.ForeignService;
import de.frachtwerk.essencium.backend.test.integration.app.NativeController;
import de.frachtwerk.essencium.backend.test.integration.app.NativeDTO;
import de.frachtwerk.essencium.backend.test.integration.app.NativeRepository;
